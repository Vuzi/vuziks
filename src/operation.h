...
typedef enum e_operation_type {
	...
	OP_LOG_NOT = 0x808, OP_LOG_AND = 0x809, OP_LOG_OR = 0x810, OP_LOG_EXIST = 0x811,

    OP_REF_GET = 0x1002, OP_REF_ACCESS = 0x1003, OP_ASSIGN = 0x1004,

    OP_VALUE = 0x2000, OP_DEC_VAR = 0x2001, OP_DEC_ATTR = 0x2002, OP_ACCES = 0x2003, OP_ATTR_ACCESS = 0x2004, OP_DELETE_VAR = 0x2005, OP_DELETE_ATTR = 0x2006,
